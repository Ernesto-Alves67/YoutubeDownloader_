...
class Ui_MainWindow(object):
	iconspath = '/media/ernesto/storage_free_30G/desenvolvimento/C++/ytDloader/icons/compressed/'
	
	## ================================================ [Estilos]
	style_padrao_1 = "color: rgb(255,255,255);"\
					"background-color: rgb(36, 31, 49);"\
					"border-radius: 10px;"
	
	stylebuttons = "QPushButton {background-color: rgb(26,31,49); "\
...
# ====================================================== [SetupUi]
	def setupUi(self, MainWindow):
		...
		self.progress_bar.setGeometry(QtCore.QRect(25, 30, 101, 18))
		...
		self.label.setGeometry(QtCore.QRect(10, 15, 180, 13))
		...
		self.tableWidget.setStyleSheet("background-color: rgb(63, 76, 106);")
		...
		self.frame_4.setGeometry(QtCore.QRect(20, 20, 711, 431))
		...
		self.central_widget = QtWidgets.QWidget(self.frame_4)
		self.central_widget.setGeometry(QtCore.QRect(350, 0, 711, 241))
		# Diretório onde estão os arquivos MP3
		diretorio = os.getcwd()
		arquivos_mp3 = self.listar_arquivos_mp3(diretorio)
		# Adicionando nomes de arquivos ao modelo de dados
		self.model.setStringList(arquivos_mp3)
		# Criação da QListView
		self.lista_musicas = QtWidgets.QListView(self.central_widget)
		self.lista_musicas.setGeometry(QtCore.QRect(80, 0, 311, 621))
		self.lista_musicas.setStyleSheet("background-color: rgb(121, 181, 181); color: rgb(0,0,0)")
		...
		self.frame_5.setGeometry(QtCore.QRect(10, 455, 731, 71))
		self.frame_5.setStyleSheet("background-color: rgb(150, 150, 150);")
		self.frame_5.setFrameShape(QtWidgets.QFrame.StyledPanel)
		self.frame_5.setFrameShadow(QtWidgets.QFrame.Raised)
		self.frame_5.setObjectName("frame_5")
		
		# ----------------------------------------- Criação do controle deslizante da reproduçao musica
		self.slider = QSlider()
		self.slider.setOrientation(Qt.Horizontal)
		self.slider.setRange(0, 100)  # Define a faixa do controle deslizante (por exemplo, de 0 a 100)

		

		## ============================== [ FRAME BOTOES MUSIC PLAYER ] ========================== ##
		self.button_anterior = QtWidgets.QPushButton(self.frame_5)
		self.button_anterior.setGeometry(QtCore.QRect(20, 30, 45, 40))
		...
		self.button_play.setGeometry(QtCore.QRect(330, 30, 45, 40))
		self.button_play.setStyleSheet(self.stylebuttons)
		self.button_play.setObjectName("button_play")

		self.button_pause = QtWidgets.QPushButton(self.frame_5)
		self.button_pause.setGeometry(QtCore.QRect(410, 30, 45, 40))
		...
		self.button_parar.setGeometry(QtCore.QRect(250, 30, 45, 40))
		...
		self.button_proxima.setGeometry(QtCore.QRect(670, 20, 45, 40))
		...
		self.layout2.addWidget(self.button_proxima, 1, 0)  # Adiciona o botão próxima na linha 1, coluna 0
		self.layout2.addWidget(self.button_parar, 1, 1)    # Adiciona o botão parar na linha 1, coluna 1
		self.layout2.addWidget(self.button_pause, 1, 2)    # Adiciona o botão pause na linha 1, coluna 2
		self.layout2.addWidget(self.button_play, 1, 3)     # Adiciona o botão play na linha 1, coluna 3
		self.layout2.addWidget(self.button_anterior,2 , 4)
		"""
