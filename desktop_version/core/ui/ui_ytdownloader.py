...
from PySide6.QtWidgets import QProgressBar, QHBoxLayout,QVBoxLayout, QLabel, QSlider, QGridLayout
from PySide6.QtCore import QDir, QStringListModel, QTimer, Qt
...
# ====================================================== [SetupUi]
    def setupUi(self, MainWindow):
        ...
        # # ============================================================ [Açoes Menu]
        self.actionSobre = QAction("Versão",MainWindow)
        self.actionSobre.setObjectName("actionSobre")
        self.actAboutApp = QAction("Sobre Yt Downloader",MainWindow)
        ...
        self.actionBuscas = QAction(MainWindow)
        self.actionBuscas.setObjectName("actionBuscas")
        self.actionDownloads = QAction(MainWindow)
        self.actionDownloads.setObjectName("actionDownloads")
        self.actionReproducao = QAction(MainWindow)
        self.actionReproducao.setObjectName("actionReproducao")
        self.actConf_ds = QAction("Download/Buscas", MainWindow)
        self.actConf_ds.setObjectName("actConf_ds")
        self.actConf_rpr = QAction("Reprodução", MainWindow)
